...
\begin{document}
  ...
  \begin{figure}[H]
    \centering
    \subfigure[]{\includegraphics[height=0.25\textwidth]{osmosis}}
    \subfigure[]{\includegraphics[height=0.25\textwidth]{rutherford}}
  ...
  \begin{figure}[H]
    \centering
    \subfigure[]{\includegraphics[height=0.25\textwidth]{rollercoaster}}
    \subfigure[]{\includegraphics[height=0.25\textwidth]{rollercoaster_02}}
